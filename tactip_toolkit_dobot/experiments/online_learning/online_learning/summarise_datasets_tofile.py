...
if __name__ == "__main__":
    ...
    with open("/home/lizzie/git/tactip_toolkit_dobot/data/TacTip_dobot/summary.json", "w") as f:
                json.dump(tabulate(to_tabulate_sorted_full, headers=headers_full, tablefmt="simple"), f)
